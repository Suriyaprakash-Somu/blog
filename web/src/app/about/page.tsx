      ...
      <PageShell className="py-12">
        ...
        <div className="mx-auto max-w-2xl space-y-4 text-center">
          ...
          <div className="rounded-xl border bg-card p-6 text-card-foreground shadow">
            <p>
              Create, manage, and publish blog posts with ease. Our platform provides
              tenant isolation and role-based access control so teams can collaborate
              safely on content creation.
            </p>
          </div>
        </div>
